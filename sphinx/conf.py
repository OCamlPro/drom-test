...
# -*- coding: utf-8 -*-
#
# drom-test documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'drom-test.tex', 'drom-test Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'drom-test', 'drom-test Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'drom-test', 'drom-test Documentation',
     author, 'drom-test', 'One line description of project.',
     'Miscellaneous'),
]
